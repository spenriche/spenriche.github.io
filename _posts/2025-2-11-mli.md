...
At its core, commercial real estate is a function of supply and demand, and heavily influenced by capital availability. The easier and cheaper it is to finance a property, often, the greater values increase. In the Canadian market, residential real estate has been the primary beneficiary of artificial financing through the MLI Select program, which offers:
